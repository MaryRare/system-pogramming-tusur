...
echo "-----------------------------------------------------------"
echo "Этот скрипт создан для копирования прав доступа с одного файла и применения их к другому файлу."
echo "Скрипт написала Кикоть Мария (студентка группы 719-1)."
echo "-----------------------------------------------------------"
